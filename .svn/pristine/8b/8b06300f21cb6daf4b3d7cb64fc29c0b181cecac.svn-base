...
$(function(){
	...
	$("#wrtieBtn").click(function(){
		$("#frm").attr("action","register").attr("method","post").submit();
	})
									...
									<div id="contents">
										<form name="frm" id="frm">
											<table>
												...
												<tr>
													<th>패스워드</th>
													<td><input type="password" name="regPass" id="regPass" maxlength="4"> * 게시판 수정,삭제시 필요합니다. 최대 4자까지 가능</td>
												</tr>
												<tr>
													<th>제목</th>
													<td><input type="text" name="regSubject" id="regSubject"></td>
												</tr>
												<tr>
													<td colspan="2"><textarea rows="30" cols="100" name="regContent" id="regContent"></textarea></td>
												</tr>
<!-- 												<tr> -->
<!-- 													<td colspan="2"><input type="checkbox" name="chk" id="chk">다른 사용자가 볼 수 없도록 비밀글로 등록합니다.</td> -->
<!-- 												</tr> -->
											</table>
										</form>
										<div>
											<a id = "wrtieBtn"><img src="" alt="글쓰기"></a> <a><img src="" alt="취소"></a>
										</div>
									</div>
								</td>
							</tr>
														...
														<tbody>
															<tr>
																...
																<td align="left"
																	...
																	<a href="/shop_info/agree.htm">
																	<font href="/shop_info/privacy.htm">
																	<font color="#808080">개인정보취급방침</font></a> &nbsp;&nbsp; 
																	<a href="javascript:no_email()"><font color="#808080">이메일무단수집거부</font>
																	</a>
																	&nbsp;&nbsp; 
