							...
							<tr align="left">
								...
								<td valign="top" width="750">
									...
									<div id="contents">
											...
											<table>
												...
												<tr>
													...
													<td><input type="text" name="regName" id="regName"
														value="${detailMap.NAME }" readonly="readonly"></td>
												</tr>
												<tr>
													<th>패스워드</th>
													<td><input type="password" name="regPass" id="regPass"
														maxlength="4" value="${detailMap.REGPASS }"> * 게시판
														수정,삭제시 필요합니다. 최대 4자까지 가능</td>
												</tr>
												<tr>
													<th>제목</th>
													<td><input type="text" name="regSubject"
														id="regSubject" value="${detailMap.SUBJECT }"></td>
												</tr>
												<tr>
													<td colspan="2"><textarea rows="30" cols="100"
															name="regContent" id="regContent">${detailMap.CONTENT }</textarea></td>
												</tr>
												<!-- 												<tr> -->
										...
										<div>
											<a id="updateBtn"><img src="" alt="수정하기"></a> <a><img
												src="" alt="취소"></a>
										</div>
									</div>
								</td>
														...
														<tbody>
															<tr>
																...
																<td align="left"
																	...
																	<a href="/shop_info/agree.htm"><font href="/shop_info/privacy.htm">
																	<font
